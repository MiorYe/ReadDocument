 ...
 * 2.2.2.	住院医嘱查询
 */
public class PullHospRecipeInfoResponse {
	...
	/**
	 * 医嘱单号	VARCHAR2(20)	医嘱单号	非空
	 */
	private String recipeNum;
	/**
	 * 流水号	VARCHAR2(20)	Number类型，同一个就诊下，流水号在医院端能够唯一标识一条处方 明细信息；	非空
	 */
	...
	/**
	 * 医嘱日期	VARCHAR2(14)	YYYYMMDDHH24MISS	非空
	 */
	private String recipeDate;
	/**
	 * 目录类别	VARCHAR2(3)	字典映射	非空
	 */
	private String listCat;
	/**
	 * 医疗项目类别	VARCHAR2(3)	字典映射	非空
	 */
	private String medicalItemCat;
	/**
	 * 医院收费项目编码	VARCHAR2(35)		非空
	 */
	private String hospitalChargeCode;
	/**
	 * 医院收费项目名称	VARCHAR2(100)		非空
	 */
	private String hospitalChargeName;
	/**
	 * 自付比例	VARCHAR2(16)	如果医保已经支付，此处填写医保的 乙类自付比例：丙类自费时 100%，乙 类按照实际比例传入；否则默认传入 本地城镇职工医保的自付比例	非空
	 */
	private String selfPayRatio;
	/**
	 * 医保收费项目编码	VARCHAR2(35)	本地就医时对应参保人的医保编号， 如目录类别是药品时，项目编码指的 是药品编码；如果目录类别是诊疗项 目时，项目编码为诊疗项目编码；如 果目录类别为医用材料时，项目编码 为医用材料编码。自费收费时，默认 为本地城镇职工医保收费项目编码	非空
	 */
	private String centreChargeCode;
	/**
	 * 医保收费项目名称	VARCHAR2(100)	参保地社保经办机构三大目录管理规范名称	非空
	 */
	private String medicareFeeitemName;
	/**
	 * 单价	VARCHAR2(16) 	4位小数  	非空
	 */
	private String price;
	/**
	 * 数量	VARCHAR2(12)	4位小数，按照目录库中的包装上传入，非招标按照实际情况传入。	非空
	 */
	private String quantity;
	/**
	 * 金额	VARCHAR2(16)	4位小数，金额 = 单价 * 数量	非空
	 */
	...
	/**
	 * 外带处方标志	VARCHAR2(3)	0 非外带处方；1 外带处方
	 */
	...
	/**
	 * 使用频次	VARCHAR2(20)	字典映射
	 */
	private String frequency;
	/**
	 * 执行天数	VARCHAR2(4)	本处方执行天数
	 */
	...
	/**
	 * 医生编码	VARCHAR2(20)	住院医生编码
	 */
	private String doctorCode;
	/**
	 * 医生姓名	VARCHAR2(50)	住院医生名称
	 */

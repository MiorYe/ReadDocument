 ...
 * 门诊结算费用查询
 */
public class PullClinicSettleInfoResponse {
	/**
	...
	/**
	 * 发票号	varchar2(20)	票据上的发票号码
	 */
	private String invoiceNO;
	/**
	 * 交易类型	varchar2(3)	1:正交易(未做取消结算操作)-1：负交易（已做取消结算操作）
	 */
	private String businessType;
	/**
	 * 医疗费总额	varchar2(16)	2位小数
	 */
	private String medicalCost;
	/**
	 * 结算日期	varchar2(14)	YYYYMMDDHH24MISS
	 */
	...
	/**
	 * 自理金额	varchar2(16)	2位小数指乙类药品、诊疗项目、服务设施中个人按比例先行支付部分
	 */
	private String selfCareAmount;
	/**
	 * 自费金额	varchar2(16)	2位小数指丙类药品、丙类诊疗项目、丙类服务设施和超限价部分
	 */
	 ...
	 * 费用明细
	 */
	private List<ClinicSettleDetail> clinicSettleDetail;
	...
	public List<ClinicSettleDetail> getClinicSettleDetail() {
		return clinicSettleDetail;
	}

	public void setClinicSettleDetail(List<ClinicSettleDetail> clinicSettleDetail) {
		this.clinicSettleDetail = clinicSettleDetail;
	}

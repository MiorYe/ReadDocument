...
public class Digest
{
  ...
  public static String hmacSign(String aValue, String aKey, String encoding) { byte[] k_ipad = new byte[64];
  ...
  public static String udpSign(String aValue) {
    try {
      ...
      return new String(Base64.encode(md.digest(input)), "UTF-8"); } catch (Exception e) {
    }
    return null;
  }
}